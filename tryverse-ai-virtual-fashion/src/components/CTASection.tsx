          ...
          <div className="relative z-10">
            ...
            <p className="text-primary-foreground/70 text-lg max-w-2xl mx-auto mb-8">
              {FEATURE_FLAGS.INVITE_ONLY_MODE
                ...
                : "Start with 20 free AI try-ons on a personal account — no credit card. Running a store? Sign up for your workspace — same core AI for shoppers and for commerce teams."}
            </p>
