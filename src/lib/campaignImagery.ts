...
import sofa from "@/assets/features-model-sofa.jpg";
...
export const campaign = {
  ...
  /** Side-profile crossing in cream tailoring against a dark shutter. Retired from the page — kept for reuse. */
  crossing: { src: crossing, alt: "Model in cream tailoring walking a crosswalk against a dark shutter" },
  /** Invisible-mannequin renders — retired from the page, kept for reuse. */
  mannequins: { src: mannequins, alt: "Three digital mannequins wearing streetwear outfits on a white field" },
  /** Model in a red sweater seated on a white boucle sofa. The workflow section only. */
  sofa: { src: sofa, alt: "Model in a red sweater and ripped jeans seated on a white boucle sofa" },
  /** Behind the scenes: the shoot itself, crew and lights inside the frame. Retired from the page — kept for reuse. */
  studio: { src: studio, alt: "Model in a white t-shirt photographed by two crew members inside a bright studio" },
  /** Oversized white shirt and wide-leg trousers against a grey sweep. Retired from the page — kept for reuse. */
